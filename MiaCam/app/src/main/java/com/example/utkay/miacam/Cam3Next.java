...
public class Cam3Next extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Bitmap bitmap = (Bitmap)intent.getParcelableExtra("photo3");
        ...
        Btnyes1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(bitmap!=null){
                    ...
                    file = new File(Environment.getExternalStorageDirectory()+"/dirr/" + kullaniciAdi,"Cihaz.jpg");
                    ...
                    Intent i= new Intent(Cam3Next.this, Cam4.class);
                    startActivity(i);
                    finish();
                }
            }
        ...
        Btnno1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i= new Intent(Cam3Next.this, Cam3.class);
                startActivity(i);
            }
        });
    }
