...
public class Cam2Next extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Bitmap bitmap = (Bitmap)intent.getParcelableExtra("photo2");
        ...
        Btnyes1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(bitmap!=null){
                    ...
                    file = new File(Environment.getExternalStorageDirectory()+"/dirr/" + kullaniciAdi,"Topuz.jpg");
                    ...
                    Intent i= new Intent(Cam2Next.this, Cam3.class);
                    startActivity(i);
                    finish();
                }
            }
        ...
        Btnno1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i= new Intent(Cam2Next.this, Cam2.class);
                startActivity(i);
            }
        });
    }
