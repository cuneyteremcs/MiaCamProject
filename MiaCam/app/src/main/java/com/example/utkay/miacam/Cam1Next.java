...
public class Cam1Next extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Bitmap bitmap = (Bitmap)intent.getParcelableExtra("photo1");
        ...
        Btnyes1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(bitmap!=null){
                    ...
                    file=new File(Environment.getExternalStorageDirectory()+"/dirr/" + kullaniciAdi);
                    if(!file.isDirectory()){
                        file.mkdir();
                    }

                    file=new File(Environment.getExternalStorageDirectory()+"/dirr/" + kullaniciAdi,"KurulumdanOnce.jpg");
                    ...
                    Intent i= new Intent(Cam1Next.this, Cam2.class);
                    startActivity(i);
                    finish();
                }
            }
        ...
        Btnno1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i= new Intent(Cam1Next.this, Cam1.class);
                startActivity(i);
            }
        });
    }
